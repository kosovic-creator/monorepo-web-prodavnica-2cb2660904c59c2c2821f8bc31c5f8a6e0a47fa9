        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            {status === 'authenticated' ? (
              ...
              <Link
                href="/auth/prijava"
                className="hidden md:flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-blue-50 transition-colors text-sm text-gray-700 hover:text-blue-600"
              >
          ...
          <div className="px-4 py-3 space-y-1">
            ...
            {status === 'authenticated' ? (
              ...
              <Link
                href="/auth/prijava"
                onClick={() => setMobileMenuOpen(false)}
                className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors"
              >
